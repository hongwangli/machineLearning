...
def innerLoop(svm, alpha_i):
    ...
    print 'alpha_i is %s error_i is %s ' % (alpha_i,error_i)
    ...
    if (svm.train_y[alpha_i] * error_i < -svm.toler) and (svm.alphas[alpha_i] < svm.C) or\
        ...
        print 'alpha_j  is %s error_j is %s ' % (alpha_j,error_j)  
        ...
        print 'change svm section:',svm.train_y[alpha_j] * (error_i - error_j) / eta
        print 'svm.alphas[alpha_j] before  : ',svm.alphas[alpha_j]
        svm.alphas[alpha_j] -= svm.train_y[alpha_j] * (error_i - error_j) / eta
        print 'svm.alphas[alpha_j] after: ',svm.alphas[alpha_j]
        # step 5: clip alpha j
        ...
        print 'abs(alpha_j_old - svm.alphas[alpha_j]):',abs(alpha_j_old - svm.alphas[alpha_j])

        print 'alpha_j_new is %s, alpha_j_old is %s' % (svm.alphas[alpha_j],alpha_j_old)                 
...
def trainSVM(train_x, train_y, C, toler, maxIter, kernelOption = ('rbf', 1.0)):
    ...
    while (iterCount < maxIter) and ((alphaPairsChanged > 0) or entireSet):
        ...
        # update alphas over examples where alpha is not 0 & not C (not on boundary)
            ...
            print 'len(nonBoundAlphasList):',len(nonBoundAlphasList)
